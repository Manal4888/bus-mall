...
function showResults() {
    ...
    for (let i = 0; i < Product.allproducts.length; i++) {
        ...
        votes[i] = Product.allproducts[i].votes + Product.allproducts[i].votes;
        console.log(votes);
        showntimes.push(Product.allproducts[i].showntimes);
        showntimes[i]=Product.allproducts[i].showntimes+ Product.allproducts[i].showntimes;
    }
...
function updateStorage() {
    ...
    let producarray = JSON.stringify(Product.allproducts);
    localStorage.setItem('Product', producarray);
}


function getUpdatedProductArray() {
